...
<img src="two_node.PNG" alt="Two Node Graph X0 -> X1" width="250px" />
...
<img src="nonlin_simpson.PNG" alt="Four Node Graph X0 -> X1, X0 -> X2, X1 -> X2, X2 -> X3" width="300px" />
...
<img src="symprod_simpson.PNG" alt="Four Node Graph X0 -> X1, X0 -> X2, X1 -> X2, X2 -> X3" width="300px" />
...
<img src="large_backdoor.PNG" alt="Large backdoor graph" width="400px" />
...
<img src="weak_arrows.PNG" alt="Weak arrows graph" width="400px" />
...
<img src="nonlin_simpson2.PNG" alt="Four Node Graph X2 -> X0, X2 -> X1, X0 -> X1, X1 -> X3" width="300px" />
...
<img src="mixed_confounding.PNG" alt="Mixed confounding graph" width="400px" />
...
<img src="chain.PNG" alt="Chain graph X0->X1->X2" width="400px" />
...
<img src="collider.PNG" alt="Collider graph X0->X1<-X2" width="400px" />
